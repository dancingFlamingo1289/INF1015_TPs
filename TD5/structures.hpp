...
public:
	...
	// Partie 1.5
	auto begin() { return elements_.get(); }
	auto end() { return elements_.get() + nElements_; }

	auto begin() const { return elements_.get(); }
	auto end() const { return elements_.get() + nElements_; }
private:
...
public:
	...
	string titre;  //NOTE: On a laissé les attributs private sans _ mais ils redeviennent public dans le TD5.
	int anneeSortie = 0;
};
